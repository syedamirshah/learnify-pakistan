...
CKEDITOR_CONFIGS = {
    'default': {
        ...
        'extraPlugins': ','.join([
            'image2',           # ‚úÖ Enables drag-to-resize for images
            'embed',            # ‚úÖ YouTube embedding
            'embedsemantic',
            'autoembed',
            'clipboard',
            'dialog',
        ...
        'removePlugins': 'image',  # ‚úÖ Removes default plugin to avoid conflict with image2

        # ‚úÖ Enables file uploads and browser dialogs
...
EMAIL_HOST_USER = 'polscience.uob@gmail.com'  # ✅ Your Gmail address
EMAIL_HOST_PASSWORD = 'fykonmbfkkuhcccn'  # ✅ Paste app password (no spaces)
