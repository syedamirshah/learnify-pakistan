...
PROVINCES = (
    ...
    ('Punjab', 'Punjab'),
    ('Sindh', 'Sindh'),
    ('Federal Territory', 'Federal Territory'),  # ✅ NEW
)
...
class User(AbstractUser):
    ...
    # ✅ Added renewal request fields inside User
...
class QuizQuestionAssignment(models.Model):
    ...
    def __str__(self):
        return f"{self.quiz.title} → {self.question_bank.title} ({self.num_questions} questions)"
